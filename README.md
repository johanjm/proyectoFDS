...
# Herramientas de desarrollo
        ...
        <br>
            ...
            <img  style=style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/github.png">
        </br>
        <br>
            <h3>Trello</h3>
            <p>Para el manejo del progreso</p>
            <img  style=style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/zenhub.png">
        </br>
        <br>
            <h3>Html y CSS</h3>
            <p>Con ellos realizaremos la estructura central del proyecto</p>
            <img  style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/html.png">
            <img  style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/css.png">
        </br>
        <br>
            <h3>JavaScript</h3>
            <p>Con esta herramienta pondremos el funcionamiento principal del sistema web.</p>
            <p>Para ello se ocuparan las librerias:</p>
            <img style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/js.png">
            <ul>
                <li>
                    <h3>React</h3>
                    <p>Para facilitar el manejo y creacion del codigo.</p>
                    <img  style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/react.png">
                </li>
                <li>
                    <h3>Ant Desing</h3>
                    <p>Para añadir funcionalidades.</p>
                    <img  style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/AntDesing.jpg">
                </li>
            </ul>  
        </br>
        <br>
            ...
            <img  style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/figma.png">
        </br>
        <br>
            <h3>Fire Base</h3>
            ...
            <img style="height: 150px; width: auto;" src="https://github.com/johanjm/proyectoFDS/blob/main/img/firebase.png">
        </br>
